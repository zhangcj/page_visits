package com.beecho.easyuse.mvc.render;

import com.beecho.easyuse.mvc.Beecho;
import com.beecho.easyuse.mvc.BeechoContext;
import com.beecho.easyuse.mvc.Const;
...
public class JspRender implements Render {
    ...
    public void render(String view, Writer writer) {
        ...
        HttpServletRequest servletRequest = BeechoContext.me().getRequest().getRaw();
        HttpServletResponse servletResponse = BeechoContext.me().getResponse().getRaw();
        try {
